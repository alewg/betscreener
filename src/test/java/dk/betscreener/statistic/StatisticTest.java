...
public class StatisticTest {
    ...
    public void testDownload() {
       ...
       stats.retrieveStatistics(leagues);
    ...
    public void testSomething() {
        ...
        for (int i = 0; i < dataArr.length; i++) {
            ...
            int rank = Integer.parseInt(dataArr[i]);
            ...
            int gamesPlayed = Integer.parseInt(dataArr[i+nameLength+1]);
            System.out.println("Games played: " + gamesPlayed);

            int gamesWon = Integer.parseInt(dataArr[i+nameLength+2]);
